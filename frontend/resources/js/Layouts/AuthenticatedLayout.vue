            ...
            <nav class="border-b border-gray-100 bg-white">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href="/tasks" :active="$page.component === 'Tasks/Index'">
                                    Mis Tareas
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center">
                            <div class="relative ms-3">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <button @click="logout" class="block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                            Log Out
                                        </button>
                                    </template>
                                </Dropdown>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink href="/tasks" :active="$page.component === 'Tasks/Index'">
                            Mis Tareas
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pb-1 pt-4">
                        ...
                        <div class="mt-3 space-y-1">
                            <button @click="logout" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">
                                Log Out
                            </button>
                        </div>
                    </div>
